...
Grandparents::Grandparents(){
	cout << "Вызвался конструктор по умолчанию класса Grandparents" << endl;
...
Grandparents::Grandparents(const Grandparents& obj){
	*this = obj;
}

Grandparents::~Grandparents(){
	cout << "Вызвался деструктор класса Grandparents" << endl;
}

Grandparents& Grandparents::operator=(const Grandparents& other){
...
ostream& operator<<(ostream& out, Grandparents& obj){
...
istream& operator>>(istream& in, Grandparents& obj) {
	cout << "Введите ФИО: ";
...
ofstream& operator<<(ofstream& fout, Grandparents& obj)
{
...
ifstream& operator>>(ifstream& fin, Grandparents& obj)
{
